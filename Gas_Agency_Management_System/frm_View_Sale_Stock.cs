...
{
    public partial class frm_View_Sale_Stock : Form
    {
        ...
        private void frm_Cylinder_Status_Load(object sender, EventArgs e)
        {
            Con_Open();
            ...
            dgv_View_Sale_Stock.DataSource = dt;
